...
@section('content')
<x-page-hero eyebrow="المتجر" title="منتجات فلاتر وتحلية المياه" description="المنتجات المنشورة فقط تظهر هنا بسعرها وتوفرها الحالي. يمكنك الطلب مباشرة عبر واتساب أو جمع المنتجات في سلة واحدة." />
<section class="store-catalog section-block">
    <div class="container-shell">
        ...
        @if($products->isEmpty())
            <div class="empty-state store-empty"><h2>لا توجد منتجات منشورة بعد</h2><p>ستظهر المنتجات هنا بعد اعتماد أسمائها وصورها وأسعارها ومخزونها من لوحة التحكم.</p><a class="button button-outline" href="{{ route('services.index') }}">تصفح الخدمات</a></div>
        @else
